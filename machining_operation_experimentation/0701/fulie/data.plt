...
set xlabel "distance from bottom of examination block[mm]" 
set xlabel  offset character 0, 0, 0 font "" textcolor lt -1 norotate
set x2label "" 
set x2label  offset character 0, 0, 0 font "" textcolor lt -1 norotate
set xrange [ 0.00000 : 60.0000 ] noreverse nowriteback
set x2range [ * : * ] noreverse nowriteback
set ylabel "examination block temperature[K]" 
...
GNUTERM = "wxt"
plot "data.dat" using 1:2 ti "18.0[W]", "data.dat" using 1:3 ti "25.9[W]", "data.dat" using 1:4 ti "41.3[W]", "data.dat" using 1:5 ti "53.3[W]", 302.45-0.092*x, 305.887-0.1315*x, 311.63-0.202*x, 316.395-0.253*x
#    EOF
